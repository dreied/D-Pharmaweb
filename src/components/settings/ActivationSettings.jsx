...
export default function ActivationSettings() {
  ...
  if (licenseState.status === "deactivated") {
    return (
      <div className="p-6 space-y-4 rounded-3xl bg-surface-container-high shadow-sm text-center">
  ...
  return (
    <div className="p-6 space-y-6 rounded-3xl bg-surface-container-high shadow-sm">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="flex flex-col items-center gap-2">
          <i
            className="fa-brands fa-whatsapp text-6xl cursor-pointer"
            style={{ color: "#25D366" }}
